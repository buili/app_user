...
import com.example.quanly.activity.ChatUserActivity;
...
public class ChatUserAdapter extends RecyclerView.Adapter<ChatUserAdapter.MyViewHolder>{
    ...
    @NonNull
    @Override
    public ChatUserAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_user, parent, false);
        return  new ChatUserAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ChatUserAdapter.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            txtid = itemView.findViewById(R.id.txtiduser2);
            txtuser = itemView.findViewById(R.id.txtusername2);
